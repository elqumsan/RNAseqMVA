...
filterCountTable <- function(countTable, phenoTable, 
  ...
  message("Filtering out ", length(zeroVarGenes)," genes with zero variance")
  ...
  message("Filtering out ", length(nearZeroVarGenes)," poor predictor genes with caret::nearZeroVar()")
