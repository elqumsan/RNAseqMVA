...
recount.metadata.frame[,recount.metadata.frame$project == (recount.metadata.frame[grep(recount.metadata.frame$characteristics,pattern = "disease status: "), "project"])]

## To select project with disease status containing at least 40 samples
recount.metadata.frame.enough.sample<- recount.metadata.frame[grep(recount.metadata.frame$sample,pattern = "disease status: "), "sample" >= 40]
dim(recount.metadata.frame.enough.sample)
