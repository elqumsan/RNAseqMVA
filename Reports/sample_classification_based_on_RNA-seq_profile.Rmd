...
### Random forest classifier
 ...
 The objective of the random forest is to ensemble weak learners into a strong learner. wherein random forest firstly performs bootstrap sampling as the training individuals (samples) of each single decision tree. next in each node, the process first randomly select subset individauls, then finds the predictor individuals that provides the best split among subset individuals. next, the process arise the full tree without pruning. in the end, we can obtain the predicted result of subset from each single tree. as a result we get the prediction result by taking majority vote.
