...
- How it works..
  knn train all samples and then classifies new instances based on similarity (distance) measure, where the similarity measure can be formulated as follows:
