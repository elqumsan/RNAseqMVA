...
Then open an R session (as above) and run the following command. 
...
I created a script named `srun_analyses.sh`, with the following content. 
...
#### Seding all jobs to slurm via a jobarray
