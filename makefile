...
targets:
	...
	@echo "	run				Run the main script (all analyses) for the selected study case (RecountID)"
...
## ----------------------------------------------------------------------
## Print main parameters and their values
IMG_FORMAT=png
...
## ----------------------------------------------------------------------
## Run the main script (all analyses) for the selected study case (RecountID)
run:
	@echo ""
	@echo "Running the main script for the study case selected in misc/00_project_parameters.yml"
	Rscript --vanilla misc/main_processes.R
#	Rscript --vanilla misc/main_processes.R ${RECOUNT_ID} ${FEATURE_TYPE}

## -----------------------------------------------------------------
## TO BE REVISED: WHICH ONES OF THE FOLLOWING TARGETS ARE STILL USEFUL?
## -----------------------------------------------------------------
...
## -----------------------------------------------------------------
## Synchronize files between IFB-core cluster and local machine
EXCLUDE_OPT= \
	--exclude '*~' \
	--exclude .DS_Store \
	--exclude '.\#*' \
